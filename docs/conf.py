...
# 'tensorcv.' prefix was removed by js
...
latex_documents = [
    (master_doc, 'tensorcv.tex', u'tensorcv documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'tensorcv', u'tensorcv documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'tensorcv', u'tensorcv documentation',
     author, 'tensorcv', 'One line description of project.',
     'Miscellaneous'),
]
...
#             if issubclass(cls, tensorcv.DataFlow):
#                 return True
#     return None

# def url_resolver(url):
#     if '.html' not in url:
#         return "https://github.com/ppwwyyxx/tensorcv/blob/master/" + url
#     else:
#         return "http://tensorcv.readthedocs.io/en/latest/" + url
