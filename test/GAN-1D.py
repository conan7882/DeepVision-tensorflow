...
class Model(GANBaseModel):
    def __init__(self, len_real_data = 100,
        ...
        self.len_real_data = len_real_data
    ...
    def _create_graph(self):
        ...
        self.real_data = tf.placeholder(tf.float32, 
                [None, self.len_real_data], 'real_data')
    ...
    def _generator(self, train = True):
        ...
        fc1 = fc(rand_vec, 1024, 'fc1')
        fc2 = fc(fc1, self.len_real_data, 'fc2')
